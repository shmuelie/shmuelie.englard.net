...
export interface AudiobookBase extends AudioObjectBase, BookBase {
...
export interface CampgroundBase extends LodgingBusinessBase, CivicStructureBase {
}
...
export interface ComicCoverArtBase extends ComicStoryBase, VisualArtworkBase {
}
...
export interface CourseBase extends LearningResourceBase, CreativeWorkBase {
...
export interface CreditCardBase extends PaymentCardBase, LoanOrCreditBase {
}
...
export interface DentistBase extends LocalBusinessBase, MedicalOrganizationBase, LocalBusinessBase {
}
...
export interface DepositAccountBase extends InvestmentOrDepositBase, BankAccountBase {
}
...
export interface EducationalOrganizationBase extends CivicStructureBase, OrganizationBase {
...
export interface ExercisePlanBase extends PhysicalActivityBase, CreativeWorkBase {
...
export interface HospitalBase extends LocalBusinessBase, CivicStructureBase, MedicalOrganizationBase {
...
export interface HowToSectionBase extends ItemListBase, CreativeWorkBase, ListItemBase {
    /**
     * A single step item (as HowToStep, text, document, video, etc.) or a HowToSection (originally misnamed 'steps'; 'step' is preferred).
     *
     * @deprecated Consider using https://schema.org/step instead.
...
export interface HowToStepBase extends ItemListBase, ListItemBase, CreativeWorkBase {
}
...
export interface LegislationObjectBase extends LegislationBase, MediaObjectBase {
...
export interface LinkRoleLeaf extends LinkRoleBase {
    "@type": "LinkRole";
}
...
export interface LocalBusinessBase extends PlaceBase, OrganizationBase {
    /**
...
export interface MedicalAudienceBase extends PeopleAudienceBase, AudienceBase {
}
...
export interface MedicalCodeBase extends MedicalEntityBase, CategoryCodeBase {
    /** A short textual code that uniquely identifies the value. */
    "codeValue"?: SchemaValue<Text>;
...
export interface MovieTheaterBase extends CivicStructureBase, LocalBusinessBase {
...
export interface OrganizationRoleLeaf extends OrganizationRoleBase {
...
export interface PalliativeProcedureBase extends MedicalProcedureBase, MedicalTherapyBase {
}
...
export interface PatientBase extends PersonBase, MedicalAudienceBase {
    /** One or more alternative conditions considered in the differential diagnosis process as output of a diagnosis process. */
    "diagnosis"?: SchemaValue<MedicalCondition | IdReference>;
    /** Specifying a drug or medicine used in a medication procedure */
    "drug"?: SchemaValue<Drug | IdReference>;
...
export interface PaymentCardBase extends EnumerationBase, FinancialProductBase {
...
export interface PerformanceRoleLeaf extends PerformanceRoleBase {
...
export interface PersonBase extends ThingBase {
    ...
    "worksFor"?: SchemaRoleValue<"worksFor", Organization | IdReference>;
}
...
export interface PharmacyBase extends LocalBusinessBase, MedicalOrganizationBase {
}
...
export interface PhysicalExamBase extends MedicalProcedureBase, EnumerationBase {
}
...
export interface RoleBase extends ThingBase {
     ...
     * NOT STANDARD
     */
    readonly "roleDescription"?: (CreativeWork | Text)[];
}
export interface RoleLeaf extends RoleBase {
    "@type": "Role";
}
/**
...
export interface SeekToActionLeaf extends ActionBase {
    "@type": "SeekToAction";
}
...
export interface SkiResortBase extends LocalBusinessBase, LodgingBusinessBase {
}
...
export interface StadiumOrArenaBase extends CivicStructureBase, LocalBusinessBase {
}
...
export interface TVSeasonBase extends CreativeWorkBase, CreativeWorkSeasonBase {
    /** The country of the principal offices of the production company or individual responsible for the movie or program. */
    "countryOfOrigin"?: SchemaValue<Country | IdReference>;
    /**
     * The TV series to which this episode or season belongs.
